...
namespace QuanLyTruongHoc.Models
{
	...
	[global::System.Data.Linq.Mapping.DatabaseAttribute(Name="DH-TNMT")]
    ...
    partial void Deleteuser(user instance);
		...
		public QuanlytruonghocDataContext() : 
				base(global::System.Configuration.ConfigurationManager.ConnectionStrings["DH_TNMTConnectionString1"].ConnectionString, mappingSource)
		{
			OnCreated();
		}
    ...
    partial void Oncomment_textChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="new_comment", Storage="_new", ThisKey="news_id", OtherKey="id", IsForeignKey=true, DeleteRule="CASCADE")]
		public @new @new
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="user_comment", Storage="_user", ThisKey="user_id", OtherKey="id", IsForeignKey=true, DeleteRule="SET NULL")]
		public user user
		{
			get
			{
    ...
    partial void OnimageNewsChanging(string value);
    partial void OnimageNewsChanged();
    ...
    partial void Onnewsgroup_idChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_imageNews", DbType="VarChar(50)")]
		public string imageNews
		{
			...
			set
			{
				if ((this._imageNews != value))
				{
					this.OnimageNewsChanging(value);
					this.SendPropertyChanging();
					this._imageNews = value;
					this.SendPropertyChanged("imageNews");
					this.OnimageNewsChanged();
				}
			}
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="news_group_new", Storage="_news_group", ThisKey="newsgroup_id", OtherKey="id", IsForeignKey=true, DeleteRule="SET NULL")]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="user_new", Storage="_user", ThisKey="user_id", OtherKey="id", IsForeignKey=true, DeleteRule="SET NULL")]
		public user user
		{
			get
			{
    ...
    partial void Onusergroup_idChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="user_group_user", Storage="_user_group", ThisKey="usergroup_id", OtherKey="id", IsForeignKey=true, DeleteRule="SET NULL")]
